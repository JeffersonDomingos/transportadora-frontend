      ...
      <div className="flex flex-grow items-center justify-between lg:justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          <button
            ...
            className="z-100 block rounded-lg border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
          ...
          <Link className="block flex-shrink-0 lg:hidden" to="/">
            <h1 className="text-lg font-bold">JEFF TRANSPORTADORA</h1>
          </Link>
        </div>
